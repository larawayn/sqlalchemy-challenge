...
* Choose the start date and end date for your trip. Make sure that your vacation range is approximately 3-15 days total.
...
* Use Pandas to print the summary statistics for the precipitation data.
  ...
  ![stats](Images/summary_stats.png)
...
* Design a query to retrieve the last 12 months of temperature observation data (TOBS).
  ...
  * Plot the results as a histogram with `bins=12`.
    ...
    ![station-histogram](Images/WAIHEE_plot.png)
...
* Plot the min, avg, and max temperature from your previous query as a bar chart.
  ...
  * Use the peak-to-peak (TMAX-TMIN) value as the y error bar (YERR).
    ...
    ![temperature](Images/trip_temp_plot.png)
...
* Calculate the rainfall per weather station using the previous year's matching dates.
    ![rainfall](Images/rainfall_df.png)
...
* Load the list of daily normals into a Pandas DataFrame and set the index equal to the date.
  ...
  ![temperature](Images/normals_df.png)


* Use Pandas to plot an area plot (`stacked=False`) for the daily normals.

  ![temperature](Images/trip_temps.png)
